...
from .gradcam_extended import GradCAMPlusPlus, XGradCAM
...
__all__ = [
    ...
    'frame_extract', 'GradCAM', 'GradCAMPlusPlus', 'XGradCAM',
    'register_all_modules', 'VideoWriter', 'get_str_type', 'track',
